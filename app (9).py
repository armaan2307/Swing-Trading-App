...
if not df_trades.empty:
    ...
    col1.metric("Active Trades", len(display_df))
    ...
    if selected_stock:
        ...
        # ---------------------------------------------------------
        with st.expander("🧮 **Position Sizing & Risk Management Calculation**", expanded=True):
            ...
            if risk_per_share > 0:
                ...
                st.warning("Invalid Stop Loss configuration.")
