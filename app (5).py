...
# Clear cache for fresh database reads
st.cache_data.clear()
...
if not df_trades.empty:
    ...
    if selected_stock:
        ...
        try:
            # Fetch data using yf.download with multi-header flattening
            ...
            if not df_chart.empty:
                ...
                fig = make_subplots(
                    ...
                    subplot_titles=(f"{selected_stock} - Price Action & Targets", "Volume Profile", "RSI (14) Momentum"),
